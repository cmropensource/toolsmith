          ...
          <div className="flex w-[80vw] items-center">
            <div className="w-1/2 p-10 h-[60vh] rounded-md content-center flex-row bg-blue-600">
              <div className="mt-10">
                ...
                <h1 className="text-5xl text-white mt-4">Manage Your Databases Efficiently</h1>
                <h1 className="mt-4 text-lg font-light text-gray-100">
                  Millions of Agencies around the world manage their databases efficiently using _Ascendix by collecting
                  all the databases in one place without writing extra code.
                </h1>
                <div className="mt-6 flex items-center">
                  <div className="border-r flex items-center border-gray-300">
                    <img src={bonnie} className="rounded-full border-2 border-white h-10" alt="Bonnie" />
                    <img src={thomas} className="rounded-full border-2 ml-[-18px] border-white h-10" alt="Thomas" />
                    <img src={jese} className="rounded-full mr-5 border-2 ml-[-15px] border-white h-10" alt="Jese" />
                  </div>
              ...
              <div className="p-10">
                ...
                <div className="mt-4">
                  ...
                  <input
                    ...
                    placeholder="Create Your _Ascendix Password"
                  />
                  <button className="w-full p-2 bg-blue-600 font-mono mt-4 text-white rounded-md justify-center flex items-center">
